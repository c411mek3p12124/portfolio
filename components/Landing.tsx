  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 atmosphere relative overflow-hidden">
      ...
      <motion.button
        ...
        initial={{ opacity: 0 }} animate={{ opacity: audio.hasTrack ? 1 : 0.55 }} transition={{ duration: 0.6, delay: 0.3 }}
        title={!audio.hasTrack ? "No music uploaded yet" : audio.playing ? "Pause music" : "Play music"}
      >
        {audio.playing ? (
