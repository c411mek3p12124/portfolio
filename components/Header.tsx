  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={audio.toggle} className="icon-btn" title={!audio.hasTrack ? "No music uploaded yet" : audio.playing ? "Pause music" : "Play music"} style={{ opacity: audio.hasTrack ? 1 : 0.55 }}>
          {audio.playing ? (
